#ifndef FACTUREBARGROUPE_H
#define FACTUREBARGROUPE_H
...
class IMPRESSIONSHARED_EXPORT factureBarGroupe
{
public:
    enum Champ
    {
        ...
        FraisBarHT = 15, Remise = 16, TotalHT = 17, TVA = 18, TotalTTC = 19, PayementRecu = 20,
        NetAPayer = 21, NomClient = 22, UniteMontant = 23, TauxTVA = 24, UniteNetAPayer = 25,
        TT = 26, TauxTT = 27
    };

public:
    factureBarGroupe(const groupe & gp);
    ~factureBarGroupe();
