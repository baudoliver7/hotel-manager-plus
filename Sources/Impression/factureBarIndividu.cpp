#include "factureBarIndividu.h"

factureBarIndividu::factureBarIndividu(const repasCompletResto & rcr)
{
...
factureBarIndividu::~factureBarIndividu()
{
    delete m_view;
}

void factureBarIndividu::setText(Champ champ, QString valeur)
{
    m_items[champ]->setPlainText(valeur);
}

void factureBarIndividu::setText(Champ champ, QString valeur, int position)
{
    m_items[champ + 5 * (position - 1)]->setPlainText(valeur);
}

void factureBarIndividu::construireFacture()
{
