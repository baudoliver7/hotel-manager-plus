...
#define ITEMS_COUNT 31

class IMPRESSIONSHARED_EXPORT factureHotelIndividu
{
public:
    enum Champ
    {
        ...
        Profession = 23, NomHotel = 24, SituationGeo = 25, BPHotel = 26, TelHotel = 27, SiteWeb = 28, TT = 29,
        TauxTT = 30, MontantDuBar = 31
    };

public:
    factureHotelIndividu(const occupation & oc);
    ~factureHotelIndividu();
