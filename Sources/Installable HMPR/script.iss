...
AppId={{9DC24BD1-6B60-4F27-BBDD-96F6BCE83885}
AppName=Hotel Manager Réception Plus
AppVerName=HMPR v 1.5
...
DefaultDirName={pf}\Hotel Manager Réception Plus
DefaultGroupName=Hotel Manager Réception Plus
AllowNoIcons=yes
...
OutputBaseFilename=HMPRV15Setup
Compression=lzma
...
[Files]
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Réception Plus\HMPR.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Réception Plus\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\Hotel Manager Réception Plus"; Filename: "{app}\HMPR.exe"
Name: "{group}\{cm:ProgramOnTheWeb,Hotel Manager Réception Plus}"; Filename: "http://www.sitifel.ci/"
Name: "{group}\{cm:UninstallProgram,Hotel Manager Réception Plus}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Hotel Manager Réception Plus"; Filename: "{app}\HMPR.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Hotel Manager Réception Plus"; Filename: "{app}\HMPR.exe"; Tasks: quicklaunchicon
