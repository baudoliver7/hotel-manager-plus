...
AppId={{9DC24BD1-6B60-4F27-BBDD-96F6BCE83884}
AppName=Hotel Manager Comptabilité Plus
AppVerName=HMPC v 1.5
...
DefaultDirName={pf}\Hotel Manager Comptabilité Plus
DefaultGroupName=Hotel Manager Comptabilité Plus
AllowNoIcons=yes
...
OutputBaseFilename=HMPCV15Setup
Compression=lzma
...
[Files]
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Comptabilité Plus\HMPC.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Comptabilité Plus\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\Hotel Manager Comptabilité Plus"; Filename: "{app}\HMPC.exe"
Name: "{group}\{cm:ProgramOnTheWeb,Hotel Manager Comptabilité Plus}"; Filename: "http://www.sitifel.ci/"
Name: "{group}\{cm:UninstallProgram,Hotel Manager Comptabilité Plus}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Hotel Manager Comptabilité Plus"; Filename: "{app}\HMPC.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Hotel Manager Comptabilité Plus"; Filename: "{app}\HMPC.exe"; Tasks: quicklaunchicon
