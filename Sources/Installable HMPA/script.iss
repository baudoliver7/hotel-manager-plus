...
AppId={{60D60533-124B-4E5C-915A-AAE7806082FE}
AppName=Hotel Manager Administration Plus
AppVerName=HM Administration Plus v 1.5
...
DefaultDirName={pf}\Hotel Manager Administration Plus
DefaultGroupName=Hotel Manager Administration Plus
AllowNoIcons=yes
...
OutputBaseFilename=HMPAV15Setup
Compression=lzma
...
[Files]
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Administration Plus\HMPA.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\Hotel Manager Plus v 1.5\Hotel Manager Plus v 1.5 portable win32\Hotel Manager Administration Plus\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\Hotel Manager Administration Plus"; Filename: "{app}\HMPA.exe"
Name: "{group}\{cm:ProgramOnTheWeb,Hotel Manager Administration Plus}"; Filename: "http://www.sitifel.ci/"
Name: "{group}\{cm:UninstallProgram,Hotel Manager Administration Plus}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Hotel Manager Administration Plus"; Filename: "{app}\HMPA.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Hotel Manager Administration Plus"; Filename: "{app}\HMPA.exe"; Tasks: quicklaunchicon
